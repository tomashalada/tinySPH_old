...
const real dt = 0.000025; //time step (initial time step)
...
const unsigned int step_end = 90001; //Endtime in steps;

const unsigned int save_output_interval = 400; //Interval to save results
const unsigned int save_output_interval_interpolated = 2000; //Interval to save interpolated results

// ========== SIMULATION CONTROL ========== //

//Case directory
std::string casePATH = "/home/tomas/Documents/__sovler/tinySPH_double_mr/cases/damBreakLong_BT/";
...
// ========== MEASUREMENT CONTROL ========== //
// ---------- water level ------------ //
const unsigned int save_WL_interval = 100; //Interval to save results
...
// ---------- pressure ------------ //
const unsigned int save_pressure_interval = 20; //Interval to save results

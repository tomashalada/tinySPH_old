...
#include "SPH_particle_system.h"
		 ...
		 ////Create_Wall_x_bt(particles, 0. - dp*2, 0.7 + dp*2, 0. , -1, {0., 1.});
		 //////	Create_Wall_x_bt(particles, 0. - dp*2, 0.7 + dp*2, 0. -dp , -1, {0., 1.});
		 //////	Create_Wall_x_bt(particles, 0. - dp*2, 0.7 + dp*2, 0. -dp*2, -1, {0., 1.});


		 ////Create_Block_of_Fluid(particles, 0.3 + dp, 0.0 + dp, 0.4, 0.2);
		 //////Create_Block_of_Fluid(particles, 0.3 + dp, 0.1 + dp, 0.4, 0.3);

		 Create_Wall_x_bt(particles, 0.+dp , 0.8 -dp, 0. , -1, {0., 1.});
		 Create_Wall_y_bt(particles, 0. , 0. + dp, 1. , -1, {1., 0.});
		 Create_Wall_y_bt(particles, 0.795 , 0. + dp , 1. , +1, {-1. , 0.});

		 Create_corner_bt(particles, -1, -1, {0., 0.}, {sqrt(2), sqrt(2)});
		 Create_corner_bt(particles, +1, -1, {0.795, 0.}, {- sqrt(2), sqrt(2)});

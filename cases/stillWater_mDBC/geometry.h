...
#include "SPH_particle_system.h"
		...
		Create_Wall_x_mdbc(particles, 0.+dp , 0.6  , 0. , -1, dp/2);
		//Create_Wall_x_lattice(particles, 0.+dp , 0.8 - dp , 0. , -1);
		Create_Wall_y_mdbc(particles, 0. , 0 + dp, 1. , -1, dp/2);

		Create_Wall_y_mdbc(particles, 0.6 , 0 + dp, 1. , +1, 0.6-dp/2);

		Create_corner_mdbc(particles, -1, -1, {0. + dp/2, 0. + dp/2});
		Create_corner_mdbc(particles, +1, -1, {0.6 - dp/2, 0. + dp/2});
	...
	//	Create_Block_of_FluidWP(particles, 0 + dp, 0 + dp, 0.6, 0.5);
		...
		//Create_Wall_x_mdbc(particles, 0.+dp , 0.9  , 0. , -1, dp/2);
		////Create_Wall_x_lattice(particles, 0.+dp , 0.8 - dp , 0. , -1);
		//Create_Wall_y_mdbc(particles, 0. , 0 + dp, 1. , -1, dp/2);

		//Create_Wall_y_mdbc(particles, 0.9 , 0 + dp, 1. , +1, 0.9-dp/2);

		//Create_corner_mdbc(particles, -1, -1, {0. + dp/2, 0. + dp/2});
		//Create_corner_mdbc(particles, +1, -1, {0.9 - dp/2, 0. + dp/2});
		//				//disabled for mDBC Create_Wall_x(particles, 0. - dp*2, 2. + dp*2, 0.4 + dp, +1);

		//				//disabled Create_Wall_y(particles, 0., 0 + dp, 0.4 , -1);
		//				//disabled Create_Wall_y(particles, 2., 0 + dp, 0.4 , +1);

		//Create_Block_of_Fluid(particles, 0 + dp, 0 + dp, 0.9-dp, 0.5);
